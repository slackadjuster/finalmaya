...
AS $$
DECLARE
  project_url TEXT := 'https://etjsxyburcyepvfzzjqe.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImV0anN4eWJ1cmN5ZXB2Znp6anFlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNDA2MDQyMSwiZXhwIjoyMDI5NjM2NDIxfQ.SxKqGFLnJUNOqVCii93WosAoVuG5b_AUxvWme59_KP0'; -- full access needed for http request to storage
